...
void lcut_int_eq(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                    const char *fcname, const char *fname);
void lcut_int_ne(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                     const char *fcname, const char *fname);
void lcut_int_gt(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                     const char *fcname, const char *fname);
void lcut_int_lt(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                     const char *fcname, const char *fname);
void lcut_int_ge(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                     const char *fcname, const char *fname);
void lcut_int_le(lcut_tc_t *tc, const int expected, const int actual, int lineno,
                     const char *fcname, const char *fname);
void lcut_str_eq(lcut_tc_t *tc, const char *expected, const char *actual, int lineno,
                    const char *fcname, const char *fname);
void lcut_stri_eq(lcut_tc_t *tc, const char *expected, const char *actual, int lineno,
                    const char *fcname, const char *fname);
void lcut_str_ne(lcut_tc_t *tc, const char *expected, const char *actual,
                     int lineno, const char *fcname, const char *fname);
void lcut_stri_ne(lcut_tc_t *tc, const char *expected, const char *actual, int lineno,
                    const char *fcname, const char *fname);
...
#define LCUT_INT_EQ(tc, expected, actual) do { \
        lcut_int_eq(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_INT_NE(tc, expected, actual) do { \
        lcut_int_ne(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_INT_GT(tc, expected, actual) do { \
        lcut_int_gt(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_INT_LT(tc, expected, actual) do { \
        lcut_int_lt(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_INT_GE(tc, expected, actual) do { \
        lcut_int_ge(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_INT_LE(tc, expected, actual) do { \
        lcut_int_le(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_STR_EQ(tc, expected, actual) do { \
        lcut_str_eq(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_STR_CASEEQ(tc, expected, actual) do { \
        lcut_stri_eq(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_STR_CASENE(tc, expected, actual) do { \
        lcut_stri_ne(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_STR_EN(tc, expected, actual, n) do { \
        lcut_str_en(tc, expected, actual, n, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)

#define LCUT_STR_NE(tc, expected, actual) do { \
        lcut_str_ne(tc, expected, actual, __LINE__, __FUNCTION__, __FILE__); \
    } while(0)
